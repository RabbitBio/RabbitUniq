...
//---------------------------------------------------------------------------------
void CKmerBinCollector::PutExtendedKmer(uint64 id, char* seq, uint32 n)
{
...
void CKmerBinCollector::Flush()
{
  ...
  //cout << "pushing: " << bin_no << " " << buffer_pos << " " << buffer_size << endl;
